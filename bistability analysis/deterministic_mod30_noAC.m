function deterministic_mod30_noAC()
...
global Unc5_sto
global Lin42_k blmp1_k Blmp1_k lin29_k Lin29_k unc5_k Unc5_k geneX_k
...
blmp1_k      = zeros(1,Lin42_count(2));
Blmp1_k      = zeros(1,Lin42_count(2));
lin29_k      = zeros(1,Lin42_count(2));
Lin29_k      = zeros(1,Lin42_count(2));
geneX_k      = zeros(1,Lin42_count(2));
unc5_k       = zeros(1,Lin42_count(2));
Unc5_k       = zeros(1,Lin42_count(2));
