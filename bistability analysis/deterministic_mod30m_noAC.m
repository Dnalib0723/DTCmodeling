function deterministic_mod30m_noAC()
...
global Unc5_sto
global Lin42_k blmp1_k Blmp1_k lin29_k Lin29_k blmp1_km Blmp1_km lin29_km Lin29_km unc5_km Unc5_km geneX_k geneX_km
...
Lin42_count= size(Lin42_numm);

Lin42_k      = zeros(1,Lin42_count(2));
blmp1_km      = zeros(1,Lin42_count(2));
Blmp1_km      = zeros(1,Lin42_count(2));
lin29_km      = zeros(1,Lin42_count(2));
Lin29_km      = zeros(1,Lin42_count(2));
unc5_km       = zeros(1,Lin42_count(2));
Unc5_km       = zeros(1,Lin42_count(2));
geneX_km      = zeros(1,Lin42_count(2));

for k=1:Lin42_count(2)

Lin42       = ones(1,N);
Lin42 = Lin42*a_ON*b*(Lin42_numm(k)/(Lin42_count(2)));
...
for j = 1:M
	...
	%Blmp1(1) = max(Blmp1_k);
	Blmp1(1) = 300;
	lin29(1) = min(lin29_k)*0;
	Lin29(1) = min(Lin29_k)*0;
	geneX(1) = min(geneX_k)*0;
    ...
    gama_Lin29      = gama_common*0.25;      gama_Lin42  = gama_common;      gama_Dre1    = gama_common;  gama_Daf12L      = gama_common*0.3;
