function stochasticsim_mod27sc()
...
global M N dt t Time_End T3_End T2_End
...
global Unc5_sto Lin42_sto unc5_sto lin29_sto
...
for j = 1:M
    ...
    % Noise tuning 
    Noiseswitch= 1; 
    noise_Daf12           = Noiseswitch;            noise_Lin42	= Noiseswitch;            noise_Dre1	  = Noiseswitch;          noise_geneX   = Noiseswitch;   
    noise_Lin29           = Noiseswitch;            noise_Blmp1	= Noiseswitch;            noise_Unc5	  = Noiseswitch;          noise_Daf12L  = Noiseswitch;  
	noise_lin29           = Noiseswitch;            noise_blmp1	= Noiseswitch;            noise_unc5	  = Noiseswitch;          noise_Daf12C   = Noiseswitch;
    ...
    gama_Daf12      = gama_common*0.03;      gama_Unc5   = gama_common*0.25;      gama_Blmp1 = gama_Blmp1;     gama_geneX      = gama_common;
    gama_Lin29      = gama_common*0.25;      gama_Lin42  = gama_common*5;      gama_Dre1    = gama_common;  gama_Daf12L      = gama_common*0.3;
	gama_unc5       = 5*gama_Unc5;      gama_blmp1 = 5*gama_Blmp1;        gama_lin29  = 5*gama_Lin29;    gama_Daf12C     = gama_common;
...
% * Daf12 *
		...
		a_Daf12_i = a_Daf12(i);
        Daf12_BPM(i)      = (eval(Daf12_num{1})+eval(Daf12_num{2}))*b*1; 
        Daf12_BPN(i)      = noise_Daf12*sqrt(2*(eval(Daf12_num{1})+eval(Daf12_num{2})))*b*1*randn;
...
unc5_sto      = zeros(M,N); unc5_sto = unc5_SS_Wt_dist;
lin29_sto      = zeros(M,N); lin29_sto = lin29_SS_Wt_dist;
