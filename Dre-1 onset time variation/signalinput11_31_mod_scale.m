function signalinput11_31_mod_scale()

global intervals N t Time_End T3_End T2_End
global a_ON a_OFF scale D_scale
...
% *** Dre1 modified***
a_Dre1        = zeros(1,N);
for i = 1:((intervals/Time_End*11.5)+1+D_scale) %0:0.35
    a_Dre1(i) = a_OFF; 
end

for i = ((intervals/Time_End*11.5)+2+D_scale):N %0.35:1
    a_Dre1(i) = a_ON; 
end
